<x-app-layout>
    <x-slot name="page_title">{{ $page_title ?? 'Clients Show |' }}</x-slot>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Clients Show</h4>
                </div>
            </div>
        </div>
                ...
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <div class="float-end">
                            ...
                            <a href="{{ url('admin-panel/clients/'. $client->id .'/edit') }}" class="btn btn-success button-last"> Edit </a>
                        </div>
                    </div>
                </div>
            </div>
