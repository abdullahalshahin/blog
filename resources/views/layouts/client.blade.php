    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":{{ (Auth::user()->theme_color == "dark") ? "true" : "false" }}, "showRightSidebarOnStart": false}'>
            ...
            <div class="leftside-menu">
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a href="{{ url('client-panel/posts') }}" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="{{ url('client-panel/my-account') }}" class="side-nav-link">
                        ...
                        <ul class="list-unstyled topbar-menu float-end mb-0">
                            ...
                            <li class="dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                                    ...
                                    <a href="{{ url('client-panel/my-account') }}" class="dropdown-item notify-item">
                                    ...
                                    <form method="POST" action="{{ url('client-panel/logout') }}">
                                        @csrf
        ...
        <script type="text/javascript">
            function changeThemeColor(color) {
                var change_theme_color_url = "{{ url('client-panel/change-theme-color') }}";
